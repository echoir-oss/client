...
export default function Home() {
    return <Page title="Home">
        <div class="h-full w-16">
            <div class="relative flex items-center justify-center h-16 w-16 bg-bgLayer rounded-[12px]">
                ...
                <div class="absolute left-0 h-[30px] w-1 bg-brand rounded-r-full"></div>
            </div>
        </div>
        <div class="rounded-[12px] bg-bgLayer w-[16rem] h-full"></div>
    </Page>
}
