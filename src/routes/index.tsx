...
export default function Home() {
    return <Page title="Home">
        <div class="h-full w-16">
            <A href="/" activeClass="groupactive" class="relative flex items-center justify-center h-16 w-16 bg-bgLayer rounded-xl">
                ...
                <div class="hidden group-[active]:block absolute left-0 h-8 w-1 bg-brand rounded-r-full"></div>
            </A>
        </div>
        <div class="rounded-xl bg-bgLayer w-64 h-full"></div>
    </Page>
}
