...
export default function Settings(): JSX.Element {
    ...
    return <div class={`settings fixed flex gap-4 w-screen justify-center top-14 bg-bg h-[calc(100vh-3.5rem)] px-3 pb-3 z-30 transition-[opacity,transform] ease-out duration-200 ${open() ? "opacity-100 scale-100" : "opacity-0 scale-150 pointer-events-none"}`}>
